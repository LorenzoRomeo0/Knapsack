...
./derived_instance_generator files/uncorr $instanceNr

./gen.out $n $range 2 2 1000
mv test.in files/weak_corr
./derived_instance_generator files/weak_corr $instanceNr

./gen.out $n $range 3 3 1000
mv test.in files/str_corr
./derived_instance_generator files/str_corr $instanceNr

./gen.out $n $range 4 4 1000
mv test.in files/inv_str_corr
./derived_instance_generator files/inv_str_corr $instanceNr

./gen.out $n $range 5 5 1000
mv test.in files/alm_str_corr
./derived_instance_generator files/alm_str_corr $instanceNr
