...
void main(int argc, char *argv[]){
    ...
    double cpu_time_used_to_alloci;
    double cpu_time_used_alloci;
    ...
    cpu_time_used_to_alloci = ((double) (end - start)) / CLOCKS_PER_SEC;

    start = clock();
    ks2_a_d_i(profits, weights, capacity, n, s_sizei, t_sizei, ti, si, (double (*)[(int)(s_sizei+1)])table_minCap, x3i);
    end = clock();
    cpu_time_used_alloci = ((double) (end - start)) / CLOCKS_PER_SEC;
    ...
    printf("CPU time used with column optimization and early allocation i:\t%f\n", cpu_time_used_alloci);
    printf("CPU time used with to allocate:\t\t\t\t\t\t\t\t\t%f\n", cpu_time_used_to_alloc);
    printf("CPU time used with to allocatei:\t\t\t\t\t\t\t\t\t%f\n", cpu_time_used_to_alloci);
